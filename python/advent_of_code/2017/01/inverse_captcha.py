...
def part2(captcha):
    ...
    for i, digit in enumerate(captcha[:-(offset)]):
        if digit == captcha[i + offset]:
            answer += int(digit) * 2
...
if __name__ == "__main__":
    print("Part 1:", part1(load_input('input.txt')))
    print("Part 2:", part2(load_input('input.txt')))
