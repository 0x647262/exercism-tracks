 ...
 * assigned after January 1, 2007 contain 12 digits, arranged in five groups,
 ...
 * English-speaking countries). The publisher code identifies the publisher
 ...
 * ISBN ends with a check digit that's used to verify the accuracy of the
 * preceding digits. Write a program that breaks down an ISBN entered by the
 * user:
 *
 *      Enter ISBN (x-x-x-x-x): 978-0-393-97950-3
 *      GS1 prefix: 978
 *      Group identifier: 0
 *      Publisher code: 393
 *      Item number: 97950
 ...
 *
 * ##### NOTE:
 * The number of digits in each group may vary; you can't assume that
